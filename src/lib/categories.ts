...
export const CATEGORIES: Record<Category, CategoryMeta> = {
  ...
  publication: { id: "publication", label: "Publicações & avaliações", color: "#60a5fa", glow: "rgba(96,165,250,0.9)", order: 6 },
  teaching: { id: "teaching", label: "Ensino", color: "#fb7185", glow: "rgba(251,113,133,0.9)", order: 7 },
  academic: { id: "academic", label: "Orientação & bancas", color: "#c084fc", glow: "rgba(192,132,252,0.9)", order: 8 },
  event: { id: "event", label: "Eventos", color: "#facc15", glow: "rgba(250,204,21,0.9)", order: 9 },
  award: { id: "award", label: "Prêmios", color: "#fbbf24", glow: "rgba(251,191,36,0.9)", order: 10 },
  skill: { id: "skill", label: "Competências", color: "#4ade80", glow: "rgba(74,222,128,0.9)", order: 11 },
  technology: { id: "technology", label: "Tecnologias", color: "#38bdf8", glow: "rgba(56,189,248,0.9)", order: 12 },
  method: { id: "method", label: "Métodos", color: "#2dd4bf", glow: "rgba(45,212,191,0.9)", order: 13 },
  datasource: { id: "datasource", label: "Fontes de dados", color: "#94a3b8", glow: "rgba(148,163,184,0.9)", order: 14 },
  area: { id: "area", label: "Áreas de pesquisa", color: "#818cf8", glow: "rgba(129,140,248,0.9)", order: 15 },
  periodical: { id: "periodical", label: "Periódicos", color: "#5eead4", glow: "rgba(94,234,212,0.9)", order: 16 },
  other: { id: "other", label: "Outros", color: "#64748b", glow: "rgba(100,116,139,0.9)", order: 17 },
};
